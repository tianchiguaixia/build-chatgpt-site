...
<style>
  ...
  <body class="">
    <div class="page">
              ...
              <div class="d-flex order-lg-2 ml-auto">
                ...
                <div class="dropdown">
                  <a href="#" class="nav-link pr-0 leading-none" data-toggle="dropdown">
                    <span class="avatar" style="background-image: url(https://q1.qlogo.cn/g?b=qq&nk=1211572283&s=100&t=1420118110)"></span>
      ...
      <li class="nav-item dropdown">
                    ...
                    用户提现记录</a>
                    <div class="dropdown-menu dropdown-menu-arrow">
                      <a href="./tixian.php" class="dropdown-item ">用户提现记录</a>
  ...
  <li class="nav-item dropdown">
    ...
    <!--<li class="nav-item dropdown">-->
    <!--                <a href="javascript:void(0)" class="nav-link" data-toggle="dropdown"><i class="fe fe-feather"></i> 计划任务</a>-->
    <!--                <div class="dropdown-menu dropdown-menu-arrow">-->
    <!--                  <a href="./golist.php" class="dropdown-item ">计划任务</a>-->
    <!--                </div>-->
    <!--              </li>-->
