                ...
                <div class="card card-aside">
                  ...
                  <div class="card-body d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center pt-5 mt-auto">
                      <div class="avatar avatar-md mr-3" style="background-image: url(https://q1.qlogo.cn/g?b=qq&nk=1211572283&s=100&t=1420118110)"></div>
                      <div>
                        <a href="./profile.html" class="text-default"><?php echo $glymz;?></a>
                        <small class="d-block text-muted">ChatGPT后台管理.</small>
                      </div>
...
$.ajax({
             ...
             <div class="col-md-12">
                       ...
                       <div class="col-md-12">
                        <div class="form-group">
                          <label class="form-label">定义跳板域名(防止分销功能导致主域屏蔽) 不需要http，例如:baidu.com</label>
